        ...
        <Row>
          <Col md={6} className="content">
            <div className="content-text">
              ...
              <Glitch text="SKY HANEL KIM" />
              <Typewriter
                options={{
                  strings: [
                    '[Fullstack Developer] Webs / Apps ',
                    '[Back-End] NodeJS / Express / EJS / MongoDB',
                    '[Front-End] React Hooks / ReactNative / Redux / Responsive Web',
                  ],
                  autoStart: true,
                  loop: true,
                }}
              ...
              <button className="hover-button">
                 <a href={"/files/RESUME.pdf"} target="_blank" download> <span> Download CV </span> </a>
              </button>
            </div>
            {this.icons()}
          </Col>
